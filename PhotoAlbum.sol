...
contract PhotoAlbum is ERC721, ERC721URIStorage, AutomationCompatibleInterface {
   ...
   // Metadata information for each stage of the NFT on IPFS.
    string[] IpfsUri = [
        "https://moccasin-important-partridge-367.mypinata.cloud/ipfs/QmewPSqEsiJcJZYNdrmtJrUcGqAzHqdhU9v72jpBnDdeNk/ciru.json",
        "https://moccasin-important-partridge-367.mypinata.cloud/ipfs/QmewPSqEsiJcJZYNdrmtJrUcGqAzHqdhU9v72jpBnDdeNk/makena.json",
        "https://moccasin-important-partridge-367.mypinata.cloud/ipfs/QmewPSqEsiJcJZYNdrmtJrUcGqAzHqdhU9v72jpBnDdeNk/oti.json"
    ];

    uint public immutable interval;
    uint public lastTimeStamp;

    constructor(uint updateInterval) ERC721("Future Kenya Chainlink Bootcamp 2024", "PHO") {
