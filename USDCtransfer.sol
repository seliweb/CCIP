...
contract CCIPTokenSenderFujiSepolia {
    ...
    // contract address of the source chain, what you paste in to set up the chain on metamask
    // https://docs.chain.link/resources/link-token-contracts#fuji-testnet
    address link= 0x0b9d5D9136855f6FEc3c0993feE6E9CE8a297846;

    // the router of the source blockchain
    ...
    // Token that I want to transfer from source chain
    address USDC = 0x5425890298aed601595a70AB815c96711a31Bc65;
    
    // destination chain selector ID number
        ...
        returns (bytes32 messageId)
    {
        ...
        // Approve Router to spend CCIP-BnM/USDC tokens we send
