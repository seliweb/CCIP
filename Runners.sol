...
contract Runners is ERC721, ERC721URIStorage, VRFConsumerBaseV2  {
    ...
    uint16 requestConfirmations = 3; // number of block chosen for confirmation. Test this later
    uint32 numWords =  1; //number of random numbers requested

    // past requests Ids. So that the same number is not generated? But then how is that random?
    uint256[] public requestIds;
    uint256 public lastRequestId;
    uint256[] public lastRandomWords;

    // Your subscription ID to be able to use the VRF service
